...
post <- function(){
  ...
  if(.Platform$OS.type == "unix"){
    ...
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\tabla_maestra.RData\" \"", SPCA_HOME, "\\tablas\\series\\tabla_maestra.RData.bkp\"", sep = ""), intern = T)
    cat("\n 1. Ultimo respaldo de la tabla maestra:", date())
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\tabla_maestra_imputada.RData\" \"", SPCA_HOME, "\\tablas\\series\\tabla_maestra_imputada.RData.bkp\"", sep = ""), intern = T)
    cat("\n 2. Ultimo respaldo de la tabla maestra imputada:", date())
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\O3Obispado.RData\" \"", SPCA_HOME, "\\tablas\\series\\O3Obispado.RData.bkp\"", sep = ""), intern = T)
    cat("\n 3. Ultimo respaldo de O3Obispado.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\O3Pastora.RData\" \"", SPCA_HOME, "\\tablas\\series\\O3Pastora.RData.bkp\"", sep = ""), intern = T)
    cat("\n 4. Ultimo respaldo de O3Pastora.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\O3Bernabe.RData\" \"", SPCA_HOME, "\\tablas\\series\\O3Bernabe.RData.bkp\"", sep = ""), intern = T)
    cat("\n 5. Ultimo respaldo de O3Bernabe.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\O3Catarina.RData\" \"", SPCA_HOME, "\\tablas\\series\\O3Catarina.RData.bkp\"", sep = ""), intern = T)
    cat("\n 6. Ultimo respaldo de O3Catarina.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\O3Nicolas.RData\" \"", SPCA_HOME, "\\tablas\\series\\O3Nicolas.RData.bkp\"", sep = ""), intern = T)
    cat("\n 7. Ultimo respaldo de O3Nicolas.RData:", date())
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\PM10Obispado.RData\" \"", SPCA_HOME, "\\tablas\\series\\PM10Obispado.RData.bkp\"", sep = ""), intern = T)
    cat("\n 8. Ultimo respaldo de PM10Obispado.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\PM10Pastora.RData\" \"", SPCA_HOME, "\\tablas\\series\\PM10Pastora.RData.bkp\"", sep = ""), intern = T)
    cat("\n 9. Ultimo respaldo de PM10Pastora.RData:", date())
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\PM10Bernabe.RData\" \"", SPCA_HOME, "\\tablas\\series\\PM10Bernabe.RData.bkp\"", sep = ""), intern = T)
    cat("\n 10. Ultimo respaldo de PM10Bernabe.RData:", date())
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\PM10Catarina.RData\" \"", SPCA_HOME, "\\tablas\\series\\PM10Catarina.RData.bkp\"", sep = ""), intern = T)
    cat("\n 11. Ultimo respaldo de PM10Catarina.RData:", date())    
    system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\series\\PM10Nicolas.RData\" \"", SPCA_HOME, "\\tablas\\series\\PM10Nicolas.RData.bkp\"", sep = ""), intern = T)
    cat("\n 12. Ultimo respaldo de PM10Nicolas.RData:", date())    
    }
  ...
  if(file.exists("tablas/pronosticos/tablas.salida.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/tablas.salida.RData' '", SPCA_HOME,
                   "/tablas/pronosticos/tablas.salida.RData.bkp'", sep = ""), intern = T)
      else
        system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\tablas.salida.RData\" \"", SPCA_HOME,
                     "\\tablas\\pronosticos\\tablas.salida.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/O3Obispado.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/O3Obispado.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/O3Obispado.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\O3Obispado.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\O3Obispado.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/O3Pastora.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix") system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/O3Pastora.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/O3Pastora.lista.pronostico.RData.bkp'", sep = ""), intern = T)
      else system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\O3Pastora.lista.pronostico.RData\" \"",
                     SPCA_HOME, "\\tablas\\pronosticos\\O3Pastora.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/O3Bernabe.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/O3Bernabe.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/O3Bernabe.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\O3Bernabe.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\O3Bernabe.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/O3Catarina.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/O3Catarina.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/O3Catarina.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\O3Catarina.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\O3Catarina.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/O3Nicolas.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/O3Nicolas.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/O3Nicolas.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\O3Nicolas.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\O3Nicolas.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/PM10Obispado.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/PM10Obispado.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/PM10Obispado.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\PM10Obispado.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\PM10Obispado.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/PM10Pastora.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/PM10Pastora.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/PM10Pastora.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\PM10Pastora.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\PM10Pastora.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/PM10Bernabe.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/PM10Bernabe.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/PM10Bernabe.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\PM10Bernabe.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\PM10Bernabe.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/PM10Catarina.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/PM10Catarina.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/PM10Catarina.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\PM10Catarina.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\PM10Catarina.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
  ...
  if(file.exists("tablas/pronosticos/PM10Nicolas.lista.pronostico.RData")){
    ...
    if(.Platform$OS.type == "unix")
      system(paste("cp '", SPCA_HOME, "/tablas/pronosticos/PM10Nicolas.lista.pronostico.RData' '",
                   SPCA_HOME, "/tablas/pronosticos/PM10Nicolas.lista.pronostico.RData.bkp'", sep = ""), intern = T)
    else
      system(paste("cmd.exe /c copy /y /b \"", SPCA_HOME, "\\tablas\\pronosticos\\PM10Nicolas.lista.pronostico.RData\" \"",
                   SPCA_HOME, "\\tablas\\pronosticos\\PM10Nicolas.lista.pronostico.RData.bkp\"", sep = ""), intern = T)
